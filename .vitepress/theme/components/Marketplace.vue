...
<template>
    <div class="container mx-auto max-w-(--vp-layout-max-width) p-6 mt-8">
        <SectionBlock
            ...
            title="Integrate & Customize Your Platform"
        ...
        <div
            v-if="error"
            class="text-center py-16 bg-red-500/10 text-red-500 rounded-lg p-4"
        >
                ...
                >
                    ...
                    >
                        <img
                            ...
                            @error="
                                $event.target.src =
                                    'data:image/svg+xml;base64,'
                            "
                        />
