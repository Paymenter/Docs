...
<template>
  <section class="relative w-full overflow-hidden mask-b-from-80% mask-b-to-100%">
    <div class="absolute inset-x-0 top-0 h-[100vh] z-0 [mask-image:linear-gradient(to_bottom,black_20%,transparent_100%)]">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center text-center min-h-[50vh] py-24 px-4">
        ...
        <span class="max-w-xl text-[40px] md:text-6xl font-semibold tracking-tighter leading-tight">
            {{ hero.text }}
        </span>
        </h1>
        ...
        <div class="flex flex-wrap gap-4 justify-center mt-4">
            <a href="/docs/getting-started/introduction" class="btn btn-primary text-white svg-left">
                {{ hero.getStartedButton }}
                <arrow-right-up-box-fill class="size-5" />
            </a>
            <a href="https://demo.paymenter.org/" target="\_blank" class="btn svg-left">
                {{ hero.demoButton }}
