...
const fetchAndProcessAllData = async () => {
    ...
    try {
        const response = await fetch(
            "https://api.paymenter.org/extensions?limit=999&birthday=true",
        );
        ...
        error.value =
            "Could not load marketplace items. Please try again later.";
    } finally {
...
const grandTotalExtensionCount = computed(
    () => masterItems.value.filter((i) => i.type === "extension").length,
);
const grandTotalThemeCount = computed(
    () => masterItems.value.filter((i) => i.type === "theme").length,
);
...
<template>
    <div class="container mx-auto max-w-(--vp-layout-max-width) p-6 mt-8">
        <div class="mb-8 relative">
            <svg
                class="absolute w-full z-0 -top-[820px]"
            ...
            <div
                class="p-6 lg:gap-12 gap-4 items-end grid grid-cols-1 md:grid-cols-2"
            >
                <div class="flex font-semibold relative lg:mb-10">
                    <SectionBlock
                        icon="emotion-happy-fill"
                        tagline="3rd anniversary"
                ...
                <div
                    class="flex items-baseline justify-end font-semibold relative"
                >
                    <div class="lg:text-[260px] text-[200px] leading-none">
                        3
                    </div>
                    <div
                        class="lg:text-[160px] text-[120px] leading-none tracking-tighter"
                    >
                        Years
                    </div>
                </div>
                ...
                <div class="relative gap-12 p-6 mb-12">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <FeatureItem
                            icon="p2p-fill"
                            title="35"
                            description="Contributing Users"
                        />
                        <FeatureItem
                            icon="customer-service-fill"
                            title="+3,000"
                            description="Closed Support Threads"
                        />
                        <FeatureItem
                            icon="line-chart-fill"
                            title="+$10,000"
                            description="Marketplace Revenue (last 4 months)"
                        />
                    </div>
                </div>
            </section>
            ...
            <section class="py-16 relative overflow-hidden">
                <div class="flex flex-col p-6 items-center relative">
                    ...
                    >
                        ...
                        <span class="flex font-normal text-(--vp-c-text-2)">
                            Paymenter has evolved from a nascent project into a
                            robust platform, supported by a dedicated global
                            community. Here are the key moments that made it
                            possible.
                        </span>
                    </div>
                </div>
                ...
                <div class="py-6">
                    <div class="max-w-3xl mx-auto">
                        <div class="relative">
                            <div
                                class="absolute left-1/2 top-0 h-full w-1 -translate-x-1/2 bg-[#4060FF]/50"
                            ></div>
                            <div class="space-y-12">
                                ...
                                >
                                    <div
                                        class="absolute left-1/2 -translate-x-1/2 bg-(--vp-c-bg) z-10"
                                    >
                                        <svg
                                            class="h-24 w-auto text-[#4060ff]/50"
                                            viewBox="0 0 38 96"
                                            fill="none"
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                    ...
                                    <div class="w-1/2 pl-12">
                                        <div class="p-4 text-left">
                                            <p
                                                class="text-sm text-(--vp-c-text-3) font-semibold"
                                            >
                                                Oct 7, 2022
                                            </p>
                                            <h3
                                                class="font-bold text-lg text-white mt-1"
                                            >
                                                First Commit
                                            </h3>
                                        </div>
                                ...
                                >
                                    ...
                                    <div class="w-1/2 pr-12">
                                        <div class="p-4 text-right">
                                            ...
                                            <h3
                                                class="font-bold text-xl text-white mt-1"
                                            >
                                                v1.3.4 (Latest Release)
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex justify-center mt-12">
                            <h3 class="font-bold text-lg text-white mt-1">
                                What's next? 👀
                            </h3>
                        </div>
                    </div>
            ...
            <section class="py-16 relative overflow-hidden">
                <div class="flex flex-col p-6 items-center relative">
                    ...
                    >
                        ...
                        <div class="flex flex-col text-3xl font-semibold">
                            Help Us Plan What's Next<span class="mt-2 text-2xl"
                                >(With a Giveaway)</span
                            >
                        </div>
                        <span class="font-normal text-(--vp-c-text-2)">
                            We're making big plans, but we need your help to get
                            it right. Take a few minutes to share your feedback
                            with us.
                            <i
                                >Plus, everyone who completes the survey joins
                                our giveaway for some very cool stickers!
                                <p class="text-sm">
                                    Giveaway ends October 15, 2025. Winners will
                ...
                <div class="mx-auto max-w-xl mt-12">
                    <div
                        class="border border-(--vp-c-divider) rounded-lg"
                        data-fillout-id="9VGsdEzUEjus"
        ...
        <SectionBlock
            icon="gift-fill"
            tagline="Birthday Sale"
            title="Celebrate With 33% Off"
        ...
        <div class="text-lg font-semibold text-center mt-2">
            <span class="text-(--vp-c-text-2)">
                Sale has ended. Thank you for celebrating with us! Visit the
                <a href="/marketplace" class="underline!">marketplace</a> to see
                our full selection of extensions and themes.
            </span>
        </div>
    </div>
</template>
